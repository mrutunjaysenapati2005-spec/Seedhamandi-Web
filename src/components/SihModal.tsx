...
export const SihModal: React.FC<SihModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-950/70 backdrop-blur-xs overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-white dark:bg-stone-900 rounded-3xl shadow-2xl border border-stone-200 dark:border-stone-700 overflow-hidden my-8 max-h-[90vh] flex flex-col">
        {/* Header Ribbon */}
        ...
        <div className="p-6 sm:p-7 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-amber-50 border-2 border-amber-200 space-y-2">
                ...
                <h4 className="font-extrabold text-stone-900 dark:text-stone-100 text-sm">Better Prices for Farmers</h4>
              ...
              <div className="p-4 rounded-2xl bg-emerald-50 border-2 border-emerald-200 space-y-2">
                ...
                <h4 className="font-extrabold text-stone-900 dark:text-stone-100 text-sm">Lower Prices for Consumers & Bulk Buyers</h4>
                <p className="text-xs text-stone-600 dark:text-stone-300 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-blue-50 border-2 border-blue-200 space-y-2">
                ...
                <h4 className="font-extrabold text-stone-900 dark:text-stone-100 text-sm">Reduced Supply Chain Inefficiencies</h4>
                <p className="text-xs text-stone-600 dark:text-stone-300 leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-950 space-y-2">
