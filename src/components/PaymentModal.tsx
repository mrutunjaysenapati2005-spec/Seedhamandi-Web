      ...
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl border border-stone-200 overflow-hidden">
        ...
        {paid ? (
          <div className="p-8 text-center space-y-3">
            ...
            <h4 className="font-extrabold text-stone-900 text-xl">Payment Verified & Escrow Locked!</h4>
            <p className="text-xs text-stone-600 max-w-xs mx-auto">
              Your payment of <span className="font-bold text-stone-900">₹{totalAmount}</span> is safely secured. Funds will only release to the farmer upon verified doorstep delivery.
            </p>
          </div>
        ) : (
          <div className="p-6 space-y-5">
            ...
            <div className="p-3.5 bg-stone-50 border border-stone-200 rounded-xl space-y-1.5 text-xs">
              <div className="flex justify-between text-stone-600">
                ...
                <span className="font-semibold text-stone-900">₹{itemsTotal}</span>
              </div>
              <div className="flex justify-between text-stone-600">
                <span>Cold Chain Farm Logistics:</span>
                <span className="font-semibold text-stone-900">₹{logisticsFee}</span>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                ...
                >
                  ...
                  <span className="text-[10px] text-stone-500 font-normal">Inspect then Pay</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] text-stone-500 font-normal">Visa, RuPay, Master</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] text-stone-500 font-normal">SBI, HDFC, ICICI, BoB</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] text-stone-500 font-normal">NABARD Subsidized</span>
                </button>
              </div>
            </div>
            ...
            {/* Method Details Pane */}
            {selectedMethod === 'UPI' && (
              <div className="p-4 bg-stone-50 border border-stone-200 rounded-xl space-y-3 text-center">
                <div className="w-32 h-32 bg-white border-2 border-emerald-600 rounded-xl mx-auto p-2 flex flex-col items-center justify-center shadow-xs">
                  {/* Visual QR Simulator */}
                ...
                <div className="text-xs text-stone-600">
                  Scan with any UPI app to pay <span className="font-bold text-stone-900">₹{totalAmount}</span>
                </div>
                <div className="flex items-center gap-2 max-w-xs mx-auto">
                  <input
                    ...
                    className="flex-1 bg-white border border-stone-300 rounded-lg px-2.5 py-1.5 text-xs focus:outline-none focus:border-emerald-600"
                  />
                </div>
              </div>
            )}
              ...
              <div className="p-4 bg-stone-50 border border-stone-200 rounded-xl space-y-2 text-xs">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <input
                    type="text"
                    placeholder="MM / YY"
                    className="bg-white border border-stone-300 rounded-lg px-3 py-2 text-xs"
                  />
                  <input
                    type="password"
                    placeholder="CVV"
